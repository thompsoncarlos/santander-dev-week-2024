const routes = {
  champions: "http://sdw24.eu-west-2.elasticbeanstalk.com/champions",
  ask: "http://sdw24.eu-west-2.elasticbeanstalk.com/champions/{id}/ask",
};
...
async function main() {
  // ✅ 1. chamada para a api do venilton
  // ✅ 2. guardar dados de personagens (state)
  await loadChampions();
